package com.app.network.http.log
...
class LoggingInterceptor private constructor(private val builder: Builder) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val ignoreLog = requestLog.tag(Invocation::class.java)?.method()?.getAnnotation(IgnoreLog::class.java)
        if (ignoreLog != null) {
            return chain.proceed(requestLog)
        }
